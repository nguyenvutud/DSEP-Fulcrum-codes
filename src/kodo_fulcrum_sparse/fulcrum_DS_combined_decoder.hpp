...
#include <kodo_fulcrum/basic_symbol_decoder_counter.hpp>
...
>
class fulcrum_DS_combined_decoder : public
    // Payload API
...
public:
    ...
    // Define the nested factory type
      using factory = kodo_core::pool_factory<fulcrum_DS_combined_decoder>;
