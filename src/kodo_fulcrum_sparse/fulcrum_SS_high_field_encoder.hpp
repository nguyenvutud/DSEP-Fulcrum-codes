...
>
class fulcrum_SS_high_field_encoder : public
	...
	///INNER GENERATOR
	kodo_fulcrum::fulcrum_sparse_shallow_full_vector_encoder<InnerField, Features>,

    // Coefficient Generator API
	kodo_core::seed_generator<

	///OUTER GENERATOR
	kodo_fulcrum::specific_sparse_uniform_index_generator_high_field<
...
{
public:
    using factory = kodo_core::pool_factory<fulcrum_SS_high_field_encoder>;
};
}
