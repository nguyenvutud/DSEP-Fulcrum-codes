...
#include <kodo_fulcrum_sparse/specific_sparse_full_vector_encoder.hpp>
...
namespace kodo_fulcrum
{
    ...
    >
    using fulcrum_sparse_shallow_full_vector_encoder = kodo_fulcrum::specific_sparse_full_vector_encoder<
        Field,
        meta::typelist<
