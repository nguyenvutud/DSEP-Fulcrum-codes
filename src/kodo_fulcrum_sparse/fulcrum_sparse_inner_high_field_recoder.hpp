...
#include <kodo_fulcrum_sparse/shallow_full_vector_decoder_counter.hpp>
...
>
class fulcrum_sparse_inner_high_field_recoder : public
    ...
    kodo_rlnc::shallow_full_vector_decoder_counter<Field, Features>,
    fulcrum_sparse_info<
	Field,
...
{
public:
    using factory = kodo_core::pool_factory<fulcrum_sparse_inner_high_field_recoder>;
};
}
