...
>
class fulcrum_SS_combined_decoder : public
    // Payload API
    kodo_core::nested_read_payload<
    kodo_core::nested_payload_size<
	kodo_fulcrum::stage_two_operation_counter<
    fulcrum_proxy_stack<kodo_core::proxy_args<>, fulcrum_payload_decoder_counter, //Added finite counter
    // Codec Header API
...
public:
    ...
    // Define the nested factory type
      using factory = kodo_core::pool_factory<fulcrum_SS_combined_decoder>;
