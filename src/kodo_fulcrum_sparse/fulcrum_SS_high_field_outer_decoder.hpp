...
>
class fulcrum_SS_high_field_outer_decoder : public
    // Payload API
    kodo_core::nested_read_payload<
    kodo_core::nested_payload_size<
    fulcrum_proxy_stack<kodo_core::proxy_args<>, fulcrum_payload_decoder_counter_high_field, //need to have a parameter for InnerField
    // Decoder API
    fulcrum_outer_symbol_mapper<
    systematic_coefficient_mapper_high_field<
...
public:
    ...
    using factory = kodo_core::pool_factory<fulcrum_SS_high_field_outer_decoder>;
};
}
