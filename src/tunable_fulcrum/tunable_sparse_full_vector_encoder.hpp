...
//#include <kodo_fulcrum_sparse/specific_sparse_uniform_index_generator_high_field.hpp>
#include <tunable_fulcrum/tunable_expansion_uniform_index_generator.hpp>
...
namespace kodo_fulcrum
{
    ...
    >
    class tunable_sparse_full_vector_encoder : public
        // Payload Codec API
		...
		//Generate the coefficient vector for Inner code
        kodo_fulcrum::tunable_expansion_uniform_index_generator<
        // Encoder API
    ...
    {
    public:
        using factory = kodo_core::pool_factory<tunable_sparse_full_vector_encoder>;
    };
}
