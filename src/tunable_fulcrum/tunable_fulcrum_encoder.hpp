...
#include <tunable_fulcrum/tunable_fulcrum_sparse_shallow_full_vector_encoder.hpp>
...
>
class tunable_fulcrum_encoder : public
...
//	kodo_fulcrum::fulcrum_sparse_shallow_full_vector_encoder<fifi::binary, Features>,
	kodo_fulcrum::tunable_fulcrum_sparse_shallow_full_vector_encoder<fifi::binary, Features>,
...
{
public:
    using factory = kodo_core::pool_factory<tunable_fulcrum_encoder>;
};
}
